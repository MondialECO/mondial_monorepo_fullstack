...
builder.Services.AddSingleton<WebApp.Services.Creator.BrandKit.LogoEngine.LogoMarkRendererRegistry>();
builder.Services.AddSingleton<WebApp.Services.Creator.BrandKit.LogoEngine.ILogoMarkRendererRegistry>(
    sp => sp.GetRequiredService<WebApp.Services.Creator.BrandKit.LogoEngine.LogoMarkRendererRegistry>());
