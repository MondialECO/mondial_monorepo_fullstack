...
| **4.5** | `57221:11932` (Support) | `max-w-[1120px] mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-6` | Inter (`font-heading font-bold`), DM Sans (`font-sans`), JetBrains Mono (`font-mono`) | Semantic tokens (`bg-card`, `border-border/80`, `bg-muted/30`, `bg-destructive/10`) | Location input card, metric strip, 2-col opportunity card details |
