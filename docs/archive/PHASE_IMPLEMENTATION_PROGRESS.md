...
| Service Provider | **Not phase-based** (superseded) — single verification gate + flat 5-section dashboard | Module 1 (Profile & Trust) built (`b29bcde`/`5e2da20`); Catalog/Leads/Workroom+Earnings/Analytics not built | See [`service-provider-flow-canon.md`](../product/service-provider-flow-canon.md) |
