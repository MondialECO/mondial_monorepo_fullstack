...
#### Database (MongoDB)
```env
MongoDbSettings__ConnectionString=mongodb+srv://mongoDB:***REMOVED***@***REMOVED***.mongodb.net/
...
JwtSettings__Key=***REMOVED***@mondialbusiness.eu
...
EmailSettings__Password=***REMOVED***
```
