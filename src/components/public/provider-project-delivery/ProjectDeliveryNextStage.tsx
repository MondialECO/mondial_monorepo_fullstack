...
export default function ProjectDeliveryNextStage() {
  const stages = [
    { num: '01. Profile & Setup', status: 'COMPLETE', isComplete: true, isCurrent: false },
    { num: '02. Sourcing & Proposals', status: 'COMPLETE', isComplete: true, isCurrent: false },
    { num: '03. Projects & Delivery', status: 'CURRENT', isComplete: false, isCurrent: true },
          ...
          <div className="lg:col-span-8 p-6 sm:p-10 rounded-[28px] bg-[#F3F2FD] border border-[#E2E1EC] shadow-xs flex flex-col justify-between gap-8">
            <div className="flex flex-col gap-4">
              <span className="px-3 py-1 rounded-full bg-[#DCE1FF] text-[#1A47C3] text-[11px] font-bold uppercase tracking-wider w-fit">
                NEXT — EARNINGS &amp; GROWTH
              </span>

              <h3 className="text-[26px] sm:text-[36px] font-heading font-bold text-[#070707] leading-tight">
                The work is complete.
                <br />
                Now turn delivery into momentum.
              </h3>

              <p className="text-[15px] sm:text-[17px] text-[#444654] leading-relaxed">
                Understand payment, platform fees and payouts — then use reviews, reputation, analytics and tier progression to strengthen future opportunities.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-4">
                ...
                >
                  <span>Continue to Earnings &amp; Growth</span>
            ...
            <div className="flex flex-wrap items-center justify-between text-[12px] text-[#747685] pt-4 border-t border-[rgba(0,0,0,0.06)]">
              <span>SERVICE PROVIDER PAGE 03 — PROJECTS &amp; DELIVERY</span>
              <Link
                href="/for-service-providers/earnings-growth"
                className="font-semibold text-[#1A47C3] hover:underline"
              >
                NEXT: EARNINGS &amp; GROWTH ➔
              </Link>
            </div>
