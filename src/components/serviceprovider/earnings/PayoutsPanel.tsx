...
export function PayoutsPanel({ data, currency }: { data: FinancialSummary; currency: string }) {
  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.72fr)]">
      <SpCard>
        <SpSectionHeader title="Request a payout" description="Create a payout through the current deterministic payment sandbox." action={<span className="inline-flex items-center gap-2 rounded-full border border-[#F0D6AE] bg-[#FBF2E7] px-3 py-1 text-xs font-semibold text-[#965F11]"><ShieldAlert className="size-3.5" aria-hidden="true" />Payment Sandbox</span>} />
