    ...
    <div className="bg-card text-card-foreground rounded-xl border shadow-sm p-4 sm:p-5 hover:shadow-md transition-shadow">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto scrollbar-hide">
          ...
          {idea.isLocalDraft ? (
            <Link
              href={idea.resumeRoute || "/dashboard/creator"}
              className="flex items-center gap-1 px-2.5 py-1 rounded-full text-xs sm:text-sm font-semibold bg-primary text-primary-foreground hover:bg-primary/90 min-w-max animate-pulse"
            >
              <Rocket size={14} />
              Resume Setup
            </Link>
