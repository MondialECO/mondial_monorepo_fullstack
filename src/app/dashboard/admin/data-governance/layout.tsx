...
export default function AdminDataGovernanceLayout({
  children,
}: {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
        ...
        <p className="text-muted-foreground max-w-md">
          Data governance inventory, retention policy management, and data lifecycle controls require SuperAdmin privileges.
        </p>
        <div className="pt-2">
