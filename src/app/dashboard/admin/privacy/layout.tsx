...
export default function AdminPrivacyLayout({
  children,
}: {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
        ...
        <p className="text-muted-foreground max-w-md">
          Privacy request administration, queue management, and compliance state transitions require SuperAdmin privileges.
        </p>
        <div className="pt-2">
