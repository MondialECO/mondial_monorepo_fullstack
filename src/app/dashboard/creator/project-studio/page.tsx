                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="flex flex-col items-center justify-center p-5 border border-border/80 bg-muted/20 rounded-xl text-center">
                    ...
                    {branding.logoType === 'ai' ? (
                      ...
                      <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-primary/70 to-primary text-white flex items-center justify-center font-extrabold text-4xl shadow-sm">
