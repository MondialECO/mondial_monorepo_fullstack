...
import { Sparkles, RefreshCw, CheckCircle2, ArrowLeft, Check, ArrowRight } from "lucide-react";
  ...
  const handleConfirm = () => {
    setState((prev) => ({
      ...
      project: {
        ...
        branding: {
          logoType: "ai",
          logoAsset: `/placeholders/logo_${selectedOption}.png`,
        ...
        {isConfirmed ? (
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-border">
              <Button variant="outline" className="rounded-xl gap-2 text-xs font-bold py-5">
                <RefreshCw className="w-4.5 h-4.5" /> Regenerate
              </Button>
              <Button onClick={handleConfirm} className="rounded-xl font-bold bg-primary text-primary-foreground hover:bg-primary/95 text-xs py-5 px-6">
                Use This Logo
              </Button>
            </div>
