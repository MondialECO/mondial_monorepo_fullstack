        ...
        <div className="grid gap-6 lg:grid-cols-3 animate-in fade-in duration-200">
          ...
          <Card className="rounded-2xl border border-border bg-card shadow-sm p-6 flex flex-col justify-between min-h-[450px]">
            ...
            <div className="flex gap-2 pt-3 border-t border-border/50">
              ...
              />
              <Button size="icon" className="rounded-xl bg-primary text-primary-foreground hover:bg-primary/95 shrink-0">
                  ...
                  <AreaChart data={FINANCIAL_DATA} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    <defs>
                      ...
                      <linearGradient id="colorEbitda" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="#00A854" stopOpacity={0.2}/>
                    ...
                    <Area type="monotone" dataKey="EBITDA" stroke="#00A854" strokeWidth={2.5} fillOpacity={1} fill="url(#colorEbitda)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </Card>
