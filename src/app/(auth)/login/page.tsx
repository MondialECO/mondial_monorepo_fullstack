        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {typeof window !== "undefined" && window.location.hostname === "localhost" && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-amber-500/10 text-amber-700 dark:bg-amber-500/10 dark:text-amber-300 font-medium py-3 rounded-lg border border-dashed border-amber-500/30 hover:bg-amber-500/20 transition-colors mt-2"
            >
              Use Developer Auto-Login (Bypass)
            </button>
          )}
        </form>
