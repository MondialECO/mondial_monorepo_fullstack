...
const data = JSON.parse(fs.readFileSync('scripts/figma_investor_diligence_node.json', 'utf8'));
const root = data.nodes['56877:113005'].document;

const outDir = 'scripts/investor_diligence_sections';
