...
const data = JSON.parse(fs.readFileSync('scripts/figma_positioning_branding_node.json', 'utf8'));
const outDir = 'scripts/positioning_branding_sections';
...
const mainDoc = data.nodes['56877:91835']?.document;
