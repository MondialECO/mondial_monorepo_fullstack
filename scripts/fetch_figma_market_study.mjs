...
async function main() {
  ...
  fs.writeFileSync('scripts/figma_market_study_node.json', JSON.stringify(nodeData, null, 2));
  console.log('✓ Saved scripts/figma_market_study_node.json');
  ...
  if (imgRes.ok) {
    ...
    if (renderUrl) {
      ...
      fs.writeFileSync('scripts/figma_market_study_57078_11039.png', buffer);
      console.log('✓ Downloaded image to scripts/figma_market_study_57078_11039.png');
    }
  } else {
