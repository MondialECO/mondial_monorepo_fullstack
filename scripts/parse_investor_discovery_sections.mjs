...
const data = JSON.parse(fs.readFileSync('scripts/figma_investor_discovery_node.json', 'utf8'));
const root = data.nodes['56877:111500'].document;

const outDir = 'scripts/investor_discovery_sections';
