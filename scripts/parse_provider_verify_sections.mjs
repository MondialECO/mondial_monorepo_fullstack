...
const data = JSON.parse(fs.readFileSync('scripts/figma_provider_verify_node.json', 'utf8'));
const root = data.nodes['56877:103319'].document;

const outDir = 'scripts/provider_verify_sections';
