...
const MAIN_NODE_ID = '56877:91083';

async function fetchProjectConcept() {
  console.log('Fetching Figma Project Identity & Concept AST...');
  ...
  try {
    ...
    fs.writeFileSync('scripts/figma_project_concept_node.json', JSON.stringify(data, null, 2));
    console.log('✓ Successfully saved scripts/figma_project_concept_node.json');
    ...
    console.error('Error fetching Project Concept:', err);
  }
}
