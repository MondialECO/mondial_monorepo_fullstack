...
const data = JSON.parse(fs.readFileSync('scripts/figma_provider_services_node.json', 'utf8'));
const root = data.nodes['56877:104761'].document;

const outDir = 'scripts/provider_services_sections';
