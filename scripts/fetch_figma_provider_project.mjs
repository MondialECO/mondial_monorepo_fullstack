...
async function fetchNode() {
  ...
  fs.writeFileSync('scripts/figma_provider_project_node.json', JSON.stringify(data, null, 2));
  console.log('Saved node data to scripts/figma_provider_project_node.json');
